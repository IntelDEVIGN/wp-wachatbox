...
<div id="wp-whatsapp-chatbox" class="wp-whatsapp-chatbox" role="region" aria-label="<?php esc_attr_e('WhatsApp Chat Widget', 'wp-whatsapp-chatbox'); ?>">
    <!-- Floating Action Button -->
    <button class="wp-whatsapp-chatbox-button" 
            aria-label="<?php esc_attr_e('Open WhatsApp Chat', 'wp-whatsapp-chatbox'); ?>"
            aria-expanded="false"
            aria-controls="chatbox-popup"
            aria-describedby="chatbox-description"
            type="button">
        <svg class="wp-whatsapp-icon" viewBox="0 0 1000 1000" width="60" height="60" aria-hidden="true">
    ...
    <div id="chatbox-description" class="sr-only">
        <?php esc_html_e('Click to start a WhatsApp conversation with us', 'wp-whatsapp-chatbox'); ?>
    </div>

    <!-- Chat Box -->
    <div class="wp-whatsapp-chatbox-popup" 
         id="chatbox-popup"
         role="dialog" 
         aria-labelledby="chatbox-title"
         aria-describedby="chatbox-welcome"
         aria-hidden="true">
        <!-- Header -->
        <?php
            ...
            <div class="wp-whatsapp-chatbox-message received">
                <div class="wp-whatsapp-chatbox-message-content">
                    <div class="wp-whatsapp-chatbox-welcome-message">
                        ...
                        // Use wp_kses_post to allow basic HTML tags while preventing XSS
                        echo wp_kses_post(nl2br($welcome_message));
                        ?>
                    </div>
                </div>
            </div>
